...
<body>
	<div id="content">
		...
		<ul id="menu">
            <?php foreach ($arMenu as $arLink):?>
			<li><a href="<?=$arLink['link']?>"><?=$arLink['name']?></a></li>
			<?php endforeach; ?>
		</ul>
	
		<div class="post">
			<div class="details">
				<h2><a href="#"><? echo $h2; ?></a></h2>
